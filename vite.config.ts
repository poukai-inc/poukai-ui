        ...
        build: {
          lib: {
            entry: {
              ...
              "atoms/DropdownMenu": resolve(__dirname, "src/atoms/DropdownMenu/index.ts"),
              ...
              "organisms/TimelineSection": resolve(
                __dirname,
                "src/organisms/TimelineSection/index.ts",
              ),
              ...
              "organisms/BlogList": resolve(__dirname, "src/organisms/BlogList/index.ts"),
